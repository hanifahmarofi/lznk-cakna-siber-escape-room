...
<head>
    ...
    <title>Cipta Bilik Baru - Cyber Escape Room</title>
...
<body class="relative pb-32 preload">
            ...
            <div class="flex justify-between h-20 items-center">
                <div class="flex items-center gap-4">
                    ...
                    <div class="hidden md:block border-l theme-border h-10 pl-4">
                        <h1 class="text-xl font-bold text-gold-gradient tracking-wide translation-target">Cipta Modul Baru</h1>
                    </div>
                </div>
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 relative z-10">
        ...
        <form action="{{ route('admin.builder.room.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="glass-card overflow-hidden mb-8 shadow-[0_0_20px_rgba(0,0,0,0.3)]">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="md:col-span-2">
                            <label class="form-label">
                                <span class="translation-target">Tajuk Modul</span> <span class="text-red-400">*</span>
                            </label>
                            <input type="text" name="title" required class="form-input translation-placeholder" placeholder="Contoh: Menghadapi Email Phishing" value="{{ old('title') }}">
                            <p class="text-[11px] theme-text-muted mt-1.5 italic font-semibold translation-target">*Sistem akan menterjemah secara automatik ke Bahasa Inggeris.</p>
                        </div>
                        <div>
                            <label class="form-label">
                                <span class="translation-target">Markah Lulus (Sijil)</span> <span class="text-red-400">*</span>
                            </label>
                            <input type="number" name="pass_mark" required class="form-input font-bold" value="{{ old('pass_mark', 80) }}" placeholder="80" min="0" max="100">
                    ...
                    <div>
                        <label class="form-label">
                            <span class="translation-target">Deskripsi & Senario Awal</span> <span class="text-red-400">*</span>
                        </label>
                        <textarea name="description" rows="4" class="form-input translation-placeholder" required placeholder="Masukkan senario awal untuk staf...">{{ old('description') }}</textarea>
                    </div>
                    <label class="flex items-center gap-3 cursor-pointer p-4 theme-check-bg border theme-border rounded-xl transition">
                        <input type="checkbox" name="is_active" value="1" class="w-5 h-5 accent-[#10b981]" checked>
                        <div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-black/10 p-4 rounded-lg border theme-border">
                        <div>
                            ...
                            <input type="url" name="video_url" value="{{ old('video_url') }}" class="form-input translation-placeholder" placeholder="Contoh: https://www.youtube.com/watch?v=XXXXX">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-2 translation-target">Format: MP4, Max: 50MB. (Sistem utamakan MP4 jika kedua-duanya diisi).</p>
                        </div>
                    </div>

                    <div>
                        <label class="form-label text-blue-400 translation-target">Arahan / Deskripsi Video</label>
                        <textarea name="video_description" rows="2" class="form-input translation-placeholder" placeholder="Contoh: Sila tonton video di atas dengan teliti sebelum meneruskan sesi...">{{ old('video_description') }}</textarea>
                    </div>
                    
                    <div>
                        <label class="form-label text-blue-400 translation-target">Masa Wajib Tonton (Saat)</label>
                        <input type="number" name="video_duration" value="{{ old('video_duration', 15) }}" min="0" class="form-input translation-placeholder" placeholder="Contoh: 120">
    ...
    <script>
        ...
        // ==========================================
        const enDictionary = {
            "Cipta Modul Baru": "Create New Module",
            ...
            "*Sistem akan menterjemah secara automatik ke Bahasa Inggeris.": "*System will auto-translate to English upon save.",
            ...
            "Format: MP4, Max: 50MB. (Sistem utamakan MP4 jika kedua-duanya diisi).": "Format: MP4, Max: 50MB. (System prioritizes MP4 if both are filled).",
            ...
            "Simpan & Cipta Modul": "Save & Create Module",
